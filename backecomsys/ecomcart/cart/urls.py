...
from .views import AddToCart,RemoveFromCart,CartView,GetCartByUserId,DeleteCartById,RemoveAllFromCart
...
urlpatterns = [
    ...
    path('api/cart/get_cart/', GetCartByUserId.as_view(), name='get-cart'),
    path('api/cart/delete/<int:cart_id>/', DeleteCartById.as_view(), name='delete_cart_by_id'),
